...
### 3. AI 초기화
온보딩 완료 후, 백그라운드에서 AI 모델이 초기화됩니다. 시스템 프롬프트를 통해 학습이 된 다음 모델을 시도합니다:
`gemini-2.5-flash`
...
#### 1 - 📸 Chats (AI 채팅)
- **갤러리에서 패션 사진 선택** → 프롬프트를 학습받은 AI가 일관된 평가기준에 맞게 실시간으로 분석합니다.
...
- 의도 : 날짜별 점수와 피드백을 체크하면서 발전해가는 사용자 본인의 모습을 확인 가능하게 의도하였습니다.
